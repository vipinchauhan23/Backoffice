...
import departmentSalesRenderer from './departmentsalesrenderer';
...
class DepartmentSales extends Component {
  static propTypes = {
  ...
  render() {
    return departmentSalesRenderer.renderDepartmentSales(this);   
  }
...
export default connect(mapStateToProps, bindAction)(DepartmentSales);
