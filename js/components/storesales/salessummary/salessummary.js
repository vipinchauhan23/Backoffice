...
import salesSummaryRenderer from './salessummaryrenderer';
...
class SalesSummary extends Component {
  ...
  render() {
    return salesSummaryRenderer.renderSalesSummary(this);   
  }
...
export default connect(mapStateToProps, bindAction)(SalesSummary);
